...
class RoomsInPropertyScreen extends StatefulWidget {
  ...
  @override
  State<RoomsInPropertyScreen> createState() => _RoomsInPropertyScreenState();
}
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'Your information is strictly confidential and protected under data protection laws. It will only be used to ensure appropriate health and safety measures.',
              style: TextStyle(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Property information is collected to helps us:\n'
