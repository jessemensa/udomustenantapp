...
import 'healthconditionorimmunesystemscreen.dart';

import 'hazards/hazardsscreen.dart';
import 'reports/reportscreen.dart';
import 'settings/settings.dart';

class DisabilityOrBedBoundScreen extends StatefulWidget {
  const DisabilityOrBedBoundScreen({super.key});

  @override
  State<DisabilityOrBedBoundScreen> createState() => _DisabilityOrBedBoundScreenState();
}

class _DisabilityOrBedBoundScreenState extends State<DisabilityOrBedBoundScreen> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Residents with a disability may be at higher risk from damp and mould exposure. This information helps us:\n'
  ...
  Widget _buildPrimaryDropdown(double bodyFontSize, bool isTablet) {
    return Column(
      ...
      children: [
        Text(
          'Any resident with a disability or bedbound?',
          style: TextStyle(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: isValid
                      ...
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => const HealthConditionOrImmuneSystemScreen(),
                        ),
                      );
