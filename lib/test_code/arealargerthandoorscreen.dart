...
import 'package:udomustenantapp/test_code/residentswithheatingscreen.dart';
...
class AreaLargerThanDoorScreen extends StatefulWidget {
  const AreaLargerThanDoorScreen({super.key});

  @override
  State<AreaLargerThanDoorScreen> createState() => _AreaLargerThanDoorScreenState();
}
...
class _AreaLargerThanDoorScreenState extends State<AreaLargerThanDoorScreen> {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'Any information you provide is strictly confidential and protected under data protection laws. It will only be used to ensure appropriate health and safety measures.',
              style: TextStyle(
  ...
  Widget _buildPrimaryDropdown(double bodyFontSize, bool isTablet) {
    return Column(
      ...
      children: [
        Text(
          'Does damp and mould cover an area larger than the door?',
          style: TextStyle(
  ...
  Widget _buildNumberInput(double bodyFontSize, bool isTablet) {
    return Column(
      ...
      children: [
        Text(
          'Tell us the number of places with this issue',
          style: TextStyle(
            fontSize: bodyFontSize - 1,
            fontFamily: 'Exo2',
            fontWeight: FontWeight.w600,
                  ...
                  child: ElevatedButton.icon(
                    onPressed: isValid
                      ...
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => const ResidentsWithHeatingScreen(),
                        ),
                      );
