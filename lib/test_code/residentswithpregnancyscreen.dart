...
class PregnancyInformationScreen extends StatefulWidget {
  ...
  @override
  State<PregnancyInformationScreen> createState() => _PregnancyInformationScreenState();
}

class _PregnancyInformationScreenState extends State<PregnancyInformationScreen> {
  String? _pregnancyStatus;
  int? _numberOfPregnantResidents;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Pregnant residents may be at higher risk from damp and mould exposure. This information helps us:\n'
  ...
  Widget _buildPrimaryDropdown(double bodyFontSize, bool isTablet) {
    return Column(
      ...
      children: [
        Text(
          'Are there any pregnant residents in the household?',
          style: TextStyle(
        ...
        DropdownButtonFormField<String>(
          ...
          onChanged: (value) {
            setState(() {
              ...
              if (!_showAdditionalInfo) {
                _numberOfPregnantResidents = null;
                _trimesterInfo = null;
        ...
        Row(
          children: [
            ...
            ...List.generate(2, (index) {
              ...
              final isSelected = _numberOfPregnantResidents == number;
              ...
              return Padding(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    setState(() {
                      _numberOfPregnantResidents = number;
            ...
            Expanded(
              child: TextFormField(
                ...
                onChanged: (value) {
                  setState(() {
                    _numberOfPregnantResidents = int.tryParse(value);
                  });
                },
              ),
            ),
  ...
  Widget _buildBottomSection(BuildContext context, double buttonHeight,
    ...
    final isValid = _pregnancyStatus != null &&
        (!_showAdditionalInfo || _numberOfPregnantResidents != null);
                  ...
                  child: ElevatedButton.icon(
                    onPressed: isValid
                      ...
                      final pregnancyData = {
                        ...
                        if (_numberOfPregnantResidents != null)
                          'numberOfPregnantResidents': _numberOfPregnantResidents,
