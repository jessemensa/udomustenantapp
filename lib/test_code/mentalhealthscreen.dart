...
class _MentalHealthScreenState extends State<MentalHealthScreen> {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'Your mental health information is strictly confidential and protected under data protection laws. It will only be used to ensure appropriate health and safety measures.',
              style: TextStyle(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Residents with any mental health issues may be at higher risk from damp and mould exposure. This information helps us:\n'
  ...
  Widget _buildPrimaryDropdown(double bodyFontSize, bool isTablet) {
    return Column(
      ...
      children: [
        Text(
          'Has this issue affected how you feel or caused you any stress or worry?',
          style: TextStyle(
